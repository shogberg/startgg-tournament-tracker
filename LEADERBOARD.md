...
The leaderboard displays the top 25 players by career points. Only players with at least 1 point are shown. See [`API.md`](API.md) for the endpoint reference and [`SQL.md`](SQL.md) for the query.
